...
export class FirstPackageInvoiceComponent implements OnInit, OnDestroy {
  ...
  public columns: any;
  public total: number;
  public title: string ="First Package Invoice";
  ...
  loadData(){
    this.comission.getFirstPurchaseIncomeItems(this.params,'invoice_package_first_purchase.php').subscribe((data:any) => {
