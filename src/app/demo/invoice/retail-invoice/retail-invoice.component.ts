...
export class RetailInvoiceComponent implements OnInit, OnDestroy {
  ...
  loadData(){
    this.comission.getFirstPurchaseIncomeItems(this.params,'invoice_retail.php').subscribe((data:any) => {
